...
class Ellipse(BaseShape):
    def __init__(self, vert_shader, frag_shader, a=1.0, b=0.5, segments=64):
        ...
        self.vertices, self.normals, self.colors, self.texcoords = self._generate_ellipse_geometry()
    ...
    def _generate_ellipse_geometry(self):
        vertices = [[0, 0, 0]]
        normals = [[0, 0, 1]]
        colors = [[1.0, 1.0, 1.0]]
        texcoords = [[0.5, 0.5]]
        ...
        for i in range(self.segments + 1):
            ...
            texcoords.append([(x + self.a) / (2 * self.a), (y + self.b) / (2 * self.b)])
