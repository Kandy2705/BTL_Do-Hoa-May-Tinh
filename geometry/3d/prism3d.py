...
class Prism(BaseShape):
    def __init__(self, vert_shader, frag_shader, sides=3, radius=1.0, height=2.0):
        super().__init__()
        ...
        self.vertices, self.normals, self.colors, self.indices = self._generate_prism_geometry()
    ...
    def _generate_prism_geometry(self):
        vertices = []
        normals = []
        colors = []
        indices = []
